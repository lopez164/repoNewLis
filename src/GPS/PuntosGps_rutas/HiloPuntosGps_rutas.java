 ...
 * @author Usuario
 */
public class HiloPuntosGps_rutas implements Runnable {

    private PuntosGps_rutas mapa;
     ...
     * @param value
     */
    public HiloPuntosGps_rutas(PuntosGps_rutas mapa, String value) {
        this.mapa = mapa;
        this.value = value;
        this.ini = mapa.ini;
    }
     ...
     * @param value
     */
    public HiloPuntosGps_rutas(PuntosGps_rutas mapa, String value, int x) {
        this.mapa = mapa;
        this.value = value;
     ...
     * @param value
     */
    public HiloPuntosGps_rutas(PuntosGps_rutas mapa, String value, String placa) {
        this.mapa = mapa;
        this.value = value;
        this.placa = placa;
        ...
        switch (value) {
            ...
            case "putWayPointsClientes":
                ...
                for (CCarros car : mapa.listadeCarros) {
                    ...
                    if (car.getPlaca().equals(mapa.placa) && mapa.manifiesto.getNumeroManifiesto().equals(mapa.numeroManifiesto)) {
                        // if (car.getWpClientes() == null || car.getWpClientes().size() == 0) {
                        car.setListaDeClientes(mapa.fechaDistribucion, mapa.manifiesto.getNumeroManifiesto());
                        //  }
                        mapa.carro = car;
              ...
              //  mapa.placa = mapa.jListaDeCarros.getSelectedValue().toString();
                for (CCarros car : mapa.listadeCarros) {
                    ...
                    if (car.getPlaca().equals(mapa.placa)) {
                        ...
                        /*Se valida si tiene GPS*/
                        if (mapa.carro.getConGps() == 1) {
                            /*asigna coordenadas de los puntos recorridos*/
                            if (mapa.carro.getLastUpdate() == 0) {
                                ...
                                if (!mapa.carro.setListaDePuntosDeRecorrido(mapa.carro.getLastUpdate())) {
    ...
    private void seeLineDePuntosRecorridos() {
        ...
        for (MyWayPoint d : mapa.listaWpPuntosRecorridos) {
            try {
                ...
                Logger.getLogger(HiloPuntosGps_rutas.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
